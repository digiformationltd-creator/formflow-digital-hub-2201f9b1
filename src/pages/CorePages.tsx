...
const webFaqs = [
  ...
  { q: "Are 3D and WebGL websites good for SEO and mobile performance?", a: "Yes, when built with responsible engineering. DigiFormation optimizes 3D web experiences using compressed GLTF/GLB models, GPU fallbacks for mobile, lazy-loaded Three.js canvases, and semantic HTML so that search crawlers index 100% of your text and metadata while users enjoy smooth 60+ FPS interactive visuals." },
